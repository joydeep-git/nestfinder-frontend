    ...
    <div className="max-w-3xl mx-auto space-y-6 p-6">
      ...
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="zero-brokerage">
          <AccordionTrigger>Is Nest Finder a zero-brokerage platform?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="connects-buyers">
          <AccordionTrigger>How does Nest Finder connect buyers with dealers?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="list-properties">
          <AccordionTrigger>Can I list my property for free?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="verified-listings">
          <AccordionTrigger>Are the property listings verified?</AccordionTrigger>
          <AccordionContent>
